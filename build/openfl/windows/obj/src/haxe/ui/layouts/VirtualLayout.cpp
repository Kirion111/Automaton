...
HXDLIN( 206)								_hx_tmp->dispatch( ::haxe::ui::events::UIEvent_obj::__alloc( HX_CTX ,::haxe::ui::events::UIEvent_obj::RENDERER_DESTROYED,null(),item),null());
            							}
...
HXDLIN( 213)								_hx_tmp->dispatch( ::haxe::ui::events::UIEvent_obj::__alloc( HX_CTX ,::haxe::ui::events::UIEvent_obj::RENDERER_CREATED,null(),item),null());
            							}
            						}
            					}
            				}
...
HXDLIN( 284)			_hx_tmp->dispatch( ::haxe::ui::events::UIEvent_obj::__alloc( HX_CTX ,::haxe::ui::events::UIEvent_obj::RENDERER_CREATED,null(),instance),null());
            		}
