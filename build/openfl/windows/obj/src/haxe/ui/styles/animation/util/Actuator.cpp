...
HXLINE( 133)					 ::haxe::ui::styles::Dimension _g = end.StaticCast< ::hx::EnumBase >()->_hx_getObject(0).StaticCast<  ::haxe::ui::styles::Dimension >();
HXDLIN( 133)					if ((_g->_hx_getIndex() == 0)) {
HXLINE( 133)						Float v = _g->_hx_getFloat(0);
...
HXLINE( 140)					switch((int)(end.StaticCast< ::hx::EnumBase >()->_hx_getIndex())){
            						case (int)0: {
HXLINE( 143)							::String v = end.StaticCast< ::hx::EnumBase >()->_hx_getString(0);
HXLINE( 144)							start = v;
            						}
            						break;
            						case (int)1: {
HXLINE( 141)							Float v = end.StaticCast< ::hx::EnumBase >()->_hx_getFloat(0);
HXLINE( 142)							start = 0;
            						}
            						break;
            						case (int)3: {
HXLINE( 141)							 ::haxe::ui::styles::Dimension _g = end.StaticCast< ::hx::EnumBase >()->_hx_getObject(0).StaticCast<  ::haxe::ui::styles::Dimension >();
HXDLIN( 141)							if ((_g->_hx_getIndex() == 0)) {
HXLINE( 141)								Float v = _g->_hx_getFloat(0);
HXLINE( 142)								start = 0;
            							}
            						}
            						break;
...
HXLINE( 153)							::String v = start.StaticCast< ::hx::EnumBase >()->_hx_getString(0);
HXDLIN( 153)							{
HXLINE( 154)								start = v;
...
HXLINE( 164)							::String v = end.StaticCast< ::hx::EnumBase >()->_hx_getString(0);
HXDLIN( 164)							{
HXLINE( 165)								end = v;
...
HXLINE( 175)				switch((int)(end.StaticCast< ::hx::EnumBase >()->_hx_getIndex())){
            					case (int)0: {
HXLINE( 198)						::String v = end.StaticCast< ::hx::EnumBase >()->_hx_getString(0);
HXDLIN( 198)						{
...
HXLINE( 222)									_hx_tmp1 = (isVariant == false);
            								}
            								else {
HXLINE( 222)									_hx_tmp1 = false;
            								}
HXDLIN( 222)								if (_hx_tmp1) {
HXLINE( 222)									_hx_tmp = (typeInfo == HX_("Variant",65,68,33,aa));
            								}
            								else {
...
HXLINE( 228)								 ::haxe::ui::styles::animation::util::StringPropertyDetails details =  ::haxe::ui::styles::animation::util::StringPropertyDetails_obj::__alloc( HX_CTX ,this->target,componentProperty,startVal,endVal);
HXLINE( 229)								this->_stringPropertyDetails->push(details);
            							}
            						}
            					}
            					break;
            					case (int)3: {
HXLINE( 191)						 ::haxe::ui::styles::Dimension _g = end.StaticCast< ::hx::EnumBase >()->_hx_getObject(0).StaticCast<  ::haxe::ui::styles::Dimension >();
HXDLIN( 191)						if ((_g->_hx_getIndex() == 0)) {
HXLINE( 191)							Float v = _g->_hx_getFloat(0);
HXDLIN( 191)							{
HXLINE( 192)								 ::Dynamic val = v;
HXLINE( 193)								if (::hx::IsNotNull( val )) {
HXLINE( 194)									 ::haxe::ui::styles::animation::util::PropertyDetails details =  ::haxe::ui::styles::animation::util::PropertyDetails_obj::__alloc( HX_CTX ,this->target,componentProperty,( (Float)(start) ),(( (Float)(val) ) - ( (Float)(start) )));
HXLINE( 195)									this->_propertyDetails->push(details);
            								}
            							}
            						}
            						else {
HXLINE( 232)							 ::Dynamic val = ::haxe::ui::styles::ValueTools_obj::calcDimension(end);
HXLINE( 233)							if (::hx::IsNotNull( val )) {
HXLINE( 234)								 ::haxe::ui::styles::animation::util::PropertyDetails details =  ::haxe::ui::styles::animation::util::PropertyDetails_obj::__alloc( HX_CTX ,this->target,componentProperty,( (Float)(start) ),(( (Float)(val) ) - ( (Float)(start) )));
HXLINE( 235)								this->_propertyDetails->push(details);
            							}
            							else {
HXLINE( 237)								 ::haxe::ui::styles::animation::util::PropertyDetails details =  ::haxe::ui::styles::animation::util::PropertyDetails_obj::__alloc( HX_CTX ,this->target,componentProperty,( (Float)(start) ),(( (Float)(end) ) - ( (Float)(start) )));
HXLINE( 238)								this->_propertyDetails->push(details);
            							}
            						}
            					}
            					break;
            					case (int)4: {
HXLINE( 176)						int v = end.StaticCast< ::hx::EnumBase >()->_hx_getInt(0);
HXDLIN( 176)						{
HXLINE( 177)							int startColor = ::hx::TCast< int >::cast(start);
HXLINE( 178)							int endColor = v;
...
HXLINE( 190)							this->_colorPropertyDetails->push(details);
            						}
            					}
            					break;
            					default:{
...
HXLINE( 309)				 ::haxe::ui::styles::animation::util::StringPropertyDetails details = _g3->__get(_g2).StaticCast<  ::haxe::ui::styles::animation::util::StringPropertyDetails >();
HXDLIN( 309)				_g2 = (_g2 + 1);
HXLINE( 310)				if (::hx::IsNotNull( details->pattern )) {
HXLINE( 311)					int newInt = ::Std_obj::_hx_int((details->startInt + (position * ( (Float)(details->changeInt) ))));
HXLINE( 312)					::String newString = ::StringTools_obj::replace(details->pattern,HX_("[[n]]",ae,fd,f0,a1),(HX_("",00,00,00,00) + newInt));
HXLINE( 313)					if (details->isVariant) {
HXLINE( 314)						 ::haxe::ui::util::VariantType v = ::haxe::ui::util::_Variant::Variant_Impl__obj::fromString(newString);
HXLINE( 315)						::Reflect_obj::setProperty(this->target,details->propertyName,v);
            					}
            					else {
HXLINE( 317)						::Reflect_obj::setProperty(this->target,details->propertyName,newString);
            					}
            				}
            				else {
HXLINE( 320)					if ((position != 1)) {
HXLINE( 321)						::Reflect_obj::setProperty(this->target,details->propertyName,details->start);
            					}
            					else {
HXLINE( 323)						::Reflect_obj::setProperty(this->target,details->propertyName,details->end);
            					}
            				}
            			}
            		}
...
HXLINE( 328)				 ::haxe::ui::styles::animation::util::ColorPropertyDetails details = _g5->__get(_g4).StaticCast<  ::haxe::ui::styles::animation::util::ColorPropertyDetails >();
HXDLIN( 328)				_g4 = (_g4 + 1);
HXLINE( 330)				int currentColor = ::Std_obj::_hx_int((((details->start >> 16) & 255) + (( (Float)(details->changeR) ) * position)));
HXLINE( 331)				int currentColor1 = ::Std_obj::_hx_int((((details->start >> 8) & 255) + (( (Float)(details->changeG) ) * position)));
HXLINE( 332)				int currentColor2 = ::Std_obj::_hx_int(((details->start & 255) + (( (Float)(details->changeB) ) * position)));
HXLINE( 329)				int currentColor3 = ::haxe::ui::util::_Color::Color_Impl__obj::fromComponents(currentColor,currentColor1,currentColor2,::Std_obj::_hx_int((((details->start >> 24) & 255) + (( (Float)(details->changeA) ) * position))));
HXLINE( 335)				::Reflect_obj::setProperty(details->target,details->propertyName,currentColor3);
            			}
            		}
            	}
