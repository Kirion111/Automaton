...
HXLINE(  90)						this->setPixels(pixels);
            					...
            					break;
            					case (int)3: {
HXLINE(  91)						Float x = c->_hx_getFloat(0);
HXDLIN(  91)						Float y = c->_hx_getFloat(1);
HXLINE(  92)						this->moveTo(x,y);
            					}
            					break;
            					case (int)4: {
HXLINE(  93)						Float x = c->_hx_getFloat(0);
HXDLIN(  93)						Float y = c->_hx_getFloat(1);
HXLINE(  94)						this->lineTo(x,y);
            					}
            					break;
            					case (int)5: {
...
HXLINE(  96)						this->strokeStyle(color,thickness,alpha);
            					}
            					break;
            					case (int)6: {
HXLINE(  97)						Float x = c->_hx_getFloat(0);
HXDLIN(  97)						Float y = c->_hx_getFloat(1);
HXDLIN(  97)						Float radius = c->_hx_getFloat(2);
HXLINE(  98)						this->circle(x,y,radius);
            					}
            					break;
            					case (int)7: {
HXLINE(  99)						 ::Dynamic color = c->_hx_getObject(0);
HXDLIN(  99)						 ::Dynamic alpha = c->_hx_getObject(1);
HXLINE( 100)						this->fillStyle(color,alpha);
            					}
            					break;
            					case (int)8: {
...
HXDLIN( 103)						Float anchorX = c->_hx_getFloat(4);
HXDLIN( 103)						Float anchorY = c->_hx_getFloat(5);
HXLINE( 104)						this->cubicCurveTo(controlX1,controlY1,controlX2,controlY2,anchorX,anchorY);
            					}
            					break;
            					case (int)10: {
HXLINE( 105)						Float x = c->_hx_getFloat(0);
HXDLIN( 105)						Float y = c->_hx_getFloat(1);
HXDLIN( 105)						Float width = c->_hx_getFloat(2);
HXDLIN( 105)						Float height = c->_hx_getFloat(3);
HXLINE( 106)						this->rectangle(x,y,width,height);
            					}
            					break;
            					case (int)11: {
HXLINE( 107)						 ::haxe::ui::util::VariantType resource = c->_hx_getObject(0).StaticCast<  ::haxe::ui::util::VariantType >();
HXDLIN( 107)						Float x = c->_hx_getFloat(1);
HXDLIN( 107)						Float y = c->_hx_getFloat(2);
HXDLIN( 107)						Float width = c->_hx_getFloat(3);
HXDLIN( 107)						Float height = c->_hx_getFloat(4);
HXLINE( 108)						this->image(resource,x,y,width,height);
            					}
            					break;
            				}
            			}
