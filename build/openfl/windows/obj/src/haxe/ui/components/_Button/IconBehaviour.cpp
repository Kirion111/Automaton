...
HXLINE( 414)			 ::haxe::ui::util::VariantType _hx_tmp = this->_value;
HXDLIN( 414)			_hx_tmp1 = ::haxe::ui::util::_Variant::Variant_Impl__obj::eq(_hx_tmp,::haxe::ui::util::_Variant::Variant_Impl__obj::fromString(HX_("",00,00,00,00)));
            		}
            		else {
