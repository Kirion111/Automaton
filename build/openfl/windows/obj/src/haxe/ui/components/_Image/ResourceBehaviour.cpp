...
HXLINE( 223)			 ::haxe::ui::util::VariantType _hx_tmp1 = this->_value;
HXDLIN( 223)			_hx_tmp = ::haxe::ui::util::_Variant::Variant_Impl__obj::eq(_hx_tmp1,::haxe::ui::util::_Variant::Variant_Impl__obj::fromString(HX_("",00,00,00,00)));
            		}
            		else {
...
HXLINE( 229)			_hx_tmp2 = ::Std_obj::isOfType(::haxe::ui::util::_Variant::Variant_Impl__obj::toComponent(this->_value),::hx::ClassOf< ::haxe::ui::components::Canvas >());
            		}
            		else {
...
HXLINE( 286)								_hx_tmp = ::hx::IsNotNull( image->get_parentComponent() );
            							}
            							else {
...
HXLINE( 287)									_hx_tmp = (_this->_layoutLocked == true);
            								}
            								else {
