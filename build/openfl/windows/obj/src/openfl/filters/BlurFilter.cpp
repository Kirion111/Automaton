...
HXLINE( 206)			Float scale = ::Math_obj::pow(((Float)0.5),( (Float)(((pass - this->_hx___horizontalPasses) >> 1)) ));
HXLINE( 207)			::openfl::filters::BlurFilter_obj::_hx___blurShader->uRadius->value[0] = ( (Float)(0) );
HXLINE( 208)			::openfl::filters::BlurFilter_obj::_hx___blurShader->uRadius->value[1] = (this->get_blurY() * scale);
            		}
